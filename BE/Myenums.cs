...

{
    public static class MyEnums
    {
        ...
        public enum Status { TransactionOpen = 1, MailHasBeenSent,Active ,CanceledByClient, CanceledByOwner,TransactionClosedThroughTheSite, Accepted, Refused, Closed, WasclosedBecauseExpired, NotRelevent }
